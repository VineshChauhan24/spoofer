...
ALLOWED_HOSTS = ['grammultitool-heroku.herokuapp.com', '127.0.0.1']
...
INTERNAL_IPS = ('127.0.0.1', 'grammultitool.herokuapp.com', '52.209.240.149')
...
ROOT_URLCONF = 'grammultitool.urls'
